...
struct basic_model {
    ...
    void Coord1(const glm::mat4 &view, const glm::mat4 proj);
    void Coord3(const glm::mat4 &view, const glm::mat4 proj, std::vector<glm::vec3> &controlPts, std::vector<glm::vec3> &interpolatedPts);
    void Coord4(const glm::mat4 &view, const glm::mat4 proj, std::vector<glm::vec3> &controlPts, std::vector<glm::vec3> &interpolatedPts);
...
private:
    ...
    // Geometry
    skeleton_model m_skeleton;  ///Skeleton
    basic_model m_model;        ///Teapot
    basic_model m_sphere_red;   ///Red Sphere
    basic_model m_sphere_green; ///Green Sphere
    basic_model m_sphere_blue;  ///Blue Sphere
